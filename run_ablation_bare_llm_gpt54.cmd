@echo off
rem ============================================================
rem  Ablation: Bare LLM (Regulation + Control + Memory removed)
...
set SCL_ABLATION=regulation, control, memory
...
rem -- gpt-4o (default) --
rem SCL_LLM_PROVIDER=openai
rem SCL_MODEL=gpt-4o

rem -- gpt-5.4 (comparison) --
...
echo.
echo  [Ablation] Bare LLM - port 8001
echo.
